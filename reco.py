...
if __name__ == '__main__':
    threshold = Threshold()
    test_path = r'E:\program file(x86)\project\工况识别\csv\jie\down_test1.csv'
    train_path = r'E:\program file(x86)\project\工况识别\csv\down\down1.csv'
    ...
    print(recognition)
    # save_path = r'./csv/re.csv'
    # write_csv(recognition1, save_path)
    print(f)
